...
function calcItemTotalCny(totalUsd: number, exchangeRate: number) {
          ...
          >
            ...
            <div className="mt-3 grid min-h-0 flex-1 gap-3 lg:grid-cols-[380px_1fr]">
              ...
              >
                ...
                <div className="mb-2 hidden grid-cols-[minmax(160px,2fr)_120px_120px_96px_64px_96px_96px_84px] gap-1.5 px-1 text-[11px] font-medium text-slate-500 md:grid">
                  <p>Товар</p>
                  <p>Общая сумма</p>
                  <p>Сумма в юанях</p>
                  <p>Размер</p>
                ...
                <div className="min-h-0 flex-1 space-y-2 overflow-auto">
                      ...
                      const itemTotalCny = calcItemTotalCny(itemTotalUsd, rateNumber);
	                    return (
                      <div key={row.key} className="rounded-lg border border-[var(--border)] bg-white p-2">
                        <div className="grid items-center gap-1.5 md:grid-cols-[minmax(160px,2fr)_120px_120px_96px_64px_96px_96px_84px]">
                          ...
                          <div className="rounded border border-[var(--border)] bg-slate-50 px-2 py-2 text-sm font-medium text-slate-700">
                            {itemTotalCny > 0 ? itemTotalCny.toFixed(2) : "—"}
                          </div>
                          <div
