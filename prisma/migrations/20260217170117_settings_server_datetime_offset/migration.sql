...
INSERT INTO "new_SystemControl" ("closedMonth", "id", "inventoryCheckedAt", "lastBackupAt", "plannedMonthlyExpensesUSD", "updatedAt", "warehouseDiscrepancyCount") SELECT "closedMonth", "id", "inventoryCheckedAt", "lastBackupAt", "plannedMonthlyExpensesUSD", "updatedAt", "warehouseDiscrepancyCount" FROM "SystemControl";
